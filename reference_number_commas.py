...
The script handles browser automation with robust error handling and progress tracking.
Results are saved incrementally to prevent data loss in case of interruption.
...
def format_with_commas(number: str) -> str:
    """Format a numeric string with commas as thousand separators."""
    ...
    try:
        while processed < total_patents:
            ...
            for _ in range(batch_size):
                ...
                pn_formatted = format_with_commas(pn_raw)
                search_string = f"{pn_formatted}"      # ← prevents auto-quotes
